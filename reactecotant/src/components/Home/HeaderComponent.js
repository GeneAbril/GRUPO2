    ...
    return (
        <nav className="navbar navbar-light bg-dark p-2">
            <div className="container">
                ...
                <Link className="text-decoration-none text-white" to="/dispositivos">Dispositivos</Link>
                <Link className="text-decoration-none text-white" to="/graficos">Graficos</Link>
                <Link className="text-decoration-none text-white" to="/comentarios">Comentarios</Link>
                ...
                <div className="form-inline my-2 my-lg-0">
                    {
                        ...
                        <div className="d-flex">
                            ...
                            <div className="form-inline my-2 my-lg-0 dropdown-toggle d-flex">
                                <p className="text-white mt-3 me-3">Usuario</p>
